...
import com.dmss.dmssadminmaintanance.restroom.RestRooTasksFragment
import com.dmss.dmssadminmaintanance.restroom.RestRoomCompletedTasksFragment
import com.dmss.dmssadminmaintanance.restroom.RestRoomPendingTasksFragment
 ...
 */
class RestRoomHomeFragment : BaseFragment() {
...
// Create a new Tab named "Third"
        ...
        navigateTo(RestRooTasksFragment())
...
// get the current selected tab's position and replace the fragment accordingly
                ...
                when (tab.position) {
                    0 -> fragment = RestRooTasksFragment()
                    1 -> fragment = RestRoomPendingTasksFragment()
                    2 -> fragment = RestRoomCompletedTasksFragment()
                }
                navigateTo(fragment!!)
            }
